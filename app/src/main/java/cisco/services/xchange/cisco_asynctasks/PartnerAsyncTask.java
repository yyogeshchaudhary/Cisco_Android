 ...
 */
public class PartnerAsyncTask extends CiscoAsyncTask {

    private Session session;
    private final ProgressDialog mDialog;

    public PartnerAsyncTask(CiscoActivity context, Message msg) {
        super(context, msg);
        session = context.getSession();
        mDialog = new ProgressDialog(context);
        mDialog.setMessage("Please wait for Partner info !!!");
        mDialog.show();
    }
    ...
    protected Object doInBackground(HashMap<String, Object>... params) {
        try {
            ...
            String responseMsg = util.getJsonResponse(AppDefine.GET_PARNTER_URL, authorization, inputMap);
            if (responseMsg != null) {
                ...
                if (responseJson.getBoolean("IsSuccess")) {
                    ...
                    return Parser.getPartner(userJson);
                }else {
                    return responseJson;
                }
            }
